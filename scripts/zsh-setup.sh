...
curl -fLo ~/.zshrc https://raw.githubusercontent.com/shihab4t/EnvSetup/main/dotfile/.zshrc
curl -fLo ~/.p10k.zsh https://raw.githubusercontent.com/shihab4t/EnvSetup/main/dotfile/.p10k.zsh
chsh -s /bin/zsh
