help() {
    ...
    commands:
    -------------
    <file_name>                                         Create file with $HOME/.cpro/template.cpp
    update <template_name>                              update template in $HOME/.cpro/template.cpp
...
then
    status chrome "https://codeforces.com/problemset/status/$2/problem/$3?friends=on"
else
    file_name=$1
    ...
    cp ~/.cpro/template.cpp $file_name
